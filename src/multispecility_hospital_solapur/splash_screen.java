...
public class splash_screen extends javax.swing.JFrame {
    ...
    public splash_screen() {
        ...
        String deathsTable ="CREATE TABLE IF NOT EXISTS vhshospital.DEATHS (" +"SR BIGINT NOT NULL UNIQUE ," +"PID BIGINT NOT NULL ," +"NAME VARCHAR(150)  NOT NULL ," +"ADMITDATE VARCHAR (10) NOT NULL ," +"NOOFDAYS INT (10) NOT NULL ," +"DRNAME VARCHAR(200) NOT NULL ," +"WARDNAME VARCHAR(10) NOT NULL ," +"WARDCHARGES INT (10) NOT NULL ," +"OPERATIONCHARGES INT (10) NOT NULL ," +"EXTRAAMOUNT INT (10) NOT NULL ," +"DEATHREASON  VARCHAR (255) NOT NULL ," +"DEATHTIME VARCHAR(10) NOT NULL ," +"DATE VARCHAR (10) NOT NULL ," +"TIME VARCHAR (10) NOT NULL);";
        try{
            try{
